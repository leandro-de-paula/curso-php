...
<div class="tituto">Formulário</div>
<h2>Cadastro</h2>
<?php 
...
if (count($_POST) > 0 ) {
    ...
    if (filter_input(INPUT_POST, "nascimento")) {
        $date = DateTime::createFromFormat('d/m/Y', $_POST['nascimento']);
        if(!$date) {
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control <?= $erros["nascimento"] ? 'is-invalid' : '' ?>" 
                ...
                value="<?= isset($_POST['nascimento']) ? $_POST['nascimento'] : ''?>">
            <div class="invalid-feedback">
                <?= $erros["nascimento"] ?>
            </div>
        </div>
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control <?= $erros["filhos"] ? 'is-invalid' : '' ?>" 
                ...
                value="<?= isset($_POST['filhos']) ? $_POST['filhos'] : ''?>">
            <div class="invalid-feedback">
                <?= $erros["filhos"] ?>
            </div>
        </div>
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control <?= $erros["salario"] ? 'is-invalid' : '' ?>" 
                ...
                value="<?= isset($_POST['salario']) ? $_POST['salario'] : ''?>">
            <div class="invalid-feedback">
                <?= $erros["salario"] ?>
            </div>
        </div>
