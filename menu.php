<nav class="modulos">
    <div class="modulo laranja">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=db&file=create_table">Criar Tabela</a></li>
            <li><a href="exercicio.php?dir=db&file=insert_table">Inserindo na Tabela</a></li>
            <li><a href="exercicio.php?dir=db&file=query">Consultar Registro</a></li>
            <li><a href="exercicio.php?dir=db&file=delete">Deleta Registro</a></li>
            <li><a href="exercicio.php?dir=db&file=delete_2">Deleta + Consulta</a></li>
            <li><a href="exercicio.php?dir=db&file=insert_table_2">Inserindo na Tabela 2</a></li>
            <li><a href="exercicio.php?dir=db&file=update">Alterar Dados</a></li>
    ...
    <div class="modulo azul">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=api&file=challenge_file">Desafio Arquivo</a></li>
            <li><a href="exercicio.php?dir=api&file=challenge_file2">Desafio Arquivo 2</a></li>
            <li><a href="exercicio.php?dir=api&file=file_folder">Exemplo Arquivo e Pasta</a></li>
            <li><a href="exercicio.php?dir=api&file=upload">Upload</a></li>
            <li><a href="exercicio.php?dir=api&file=download">Download</a></li>
            <li><a href="exercicio.php?dir=api&file=imagem">Imagem</a></li>
        </ul>
    </div>
    ...
    <div class="modulo verde">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=tratamento_erro&file=desafio_intdiv_index">Desafio IntDiv</a></li>
            <li><a href="exercicio.php?dir=tratamento_erro&file=gerenciador_erro">Erro Handler</a></li>
        </ul>
    </div>
    <div class="modulo laranja-escuro">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=namespace/sorteio1.5/view&file=prize_draw">Sorteio1.5</a></li>
        </ul>
    </div>
    <div class="modulo roxo-escuro">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=includes&file=desafio_include_objeto">Desafio Include com Objeto</a></li>
        </ul>
    </div>
    <div class="modulo azul-escuro">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=classes_objetos&file=cadastro1.0">Cadastro 1.0</a></li>
    ...
    <div class="modulo vermelho-escuro">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=funcoes&file=arg_padrao">Arg Padrão</a></li>
    ...
    <div class="modulo verde-escuro">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=repeticoes&file=desafio_tabela_resposta">Desafio Tabela Resposta</a></li>
        </ul>
    </div>
    <div class="modulo laranja">
        <h3>5. Array</h3>
        <ul>
            ...
            <li><a href="exercicio.php?dir=array&file=sorteio">Sorteio</a></li>
    ...
    <div class="modulo verde">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=basico&file=comentario">Comentário PHP</a></li>
